...
export const suggestionCategories: PromptCategory[] = [
    {
        ...
        prompts: [
            ...
            { title: "Cyberpunk", prompt: "Selfie du personnage dans une ville au style Cyberpunk (réaliste)." },
            ...
            { title: "Nature sauvage", prompt: "Selfie du personnage dans un paysage de nature sauvage (réaliste, naturel)." },
